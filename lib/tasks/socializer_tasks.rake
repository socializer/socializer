...
def enhance_assets_precompile
  ...
  deps = yarn_install_available? ? [] : ["socializer:webpacker:yarn_install"]
  Rake::Task["assets:precompile"].enhance(deps) do
    Rake::Task["socializer:webpacker:compile"].invoke
  end
end

# Compile packs after we've compiled all other assets during precompilation
webpacker_precompile = ENV.fetch("WEBPACKER_PRECOMPILE", false)

  ...
  class ActivityAudienceList
    ...
    def perform
      ...
      @activity.audiences.each do |audience|
        ...
        list.concat(build_audience_list(audience))
      end

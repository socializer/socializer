...
ActiveRecord::Schema.define(version: 20140131070951) do
  ...
  add_index "socializer_activity_objects", ["activitable_type", "activitable_id"], name: "index_activity_objects_on_activitable"
  ...
  add_index "socializer_audiences", ["activity_id", "activity_object_id"], name: "index_audiences_on_activity_id__activity_object_id", unique: true

...
module Socializer
  RSpec.describe People::PlacesController, type: :routing do
    ...
    describe "routing" do
      ...
      it "does not route to #show" do
        expect(get: "/people/1/places/1/show").to_not be_routable
      end

      it "does not route to #edit" do
        expect(get: "/people/1/places/1/edit").to_not be_routable
      end

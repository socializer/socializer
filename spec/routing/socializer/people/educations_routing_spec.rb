  ...
  RSpec.describe People::EducationsController do
    ...
    context "with routing" do
      ...
      it "does not route to #show" do
        expect(get: "/people/1/educations/1/show").not_to be_routable
      end
      ...
      it "routes to #update using patch" do
        expect(patch: "/people/1/educations/1")
          .to route_to("socializer/people/educations#update",
                       person_id: "1", id: "1")
      end
      ...
      it "routes to #destroy" do
        expect(delete: "/people/1/educations/1")
          .to route_to("socializer/people/educations#destroy",
                       person_id: "1", id: "1")
      end
    end
  end

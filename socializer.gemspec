...
Gem::Specification.new do |s|
  ...
  s.add_dependency("elasticsearch-rails",  "~> 5.0.2")
  ...
  s.add_dependency("uglifier",             ">= 4.0.2")
  ...
  s.add_development_dependency("i18n-tasks",           "~> 0.9.19")
  ...
  s.add_development_dependency("rubocop-rspec",        "~> 1.21.0")
  s.add_development_dependency("scss_lint",            "~> 0.56.0")
end

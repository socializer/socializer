...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency('brakeman',             '~> 2.6.3')
  ...
  spec.add_development_dependency('i18n-tasks',           '~> 0.7.8')
  spec.add_development_dependency('inch',                 '~> 0.5.5')
